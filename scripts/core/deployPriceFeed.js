...
async function deployPriceFeed() {
  ...
  // const tokenArr = [btc, eth, wld, op, feth, usdc, usdt]
  // const fastPriceTokens = [btc, eth, feth, wld, op]
  const { btc, eth, wld, op, usdc, usdt } = tokens
  const tokenArr = [btc, eth, wld, op, usdc, usdt]
  const fastPriceTokens = [btc, eth, wld, op]
  // const { eth, cbeth, usdbc, dai } = tokens
  // const tokenArr = [eth, cbeth, usdbc, dai]
  // const fastPriceTokens = [eth, cbeth]
